    ...
    <section id="skills" className="py-32 px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Core Skills */}
          <div className="group bg-white/80 backdrop-blur rounded-3xl border border-neutral-200 p-10 hover:border-indigo-200 hover:shadow-xl transition-all duration-300 neu-shadow">
            <div className="mb-8">
